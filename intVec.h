...
/* intVec.h
 * The intVec.h file holds all the prototype functions to be implemented into the 
 * implementation files. It also defines the pointer to the struct IntVecNode
 */
...
/** intTop()
 * precondition: edges has been initialized or intSize(myVec) > 0
 */
